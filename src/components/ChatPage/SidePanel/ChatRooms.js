...
export class ChatRooms extends Component {
    ...
    handleNotification = (chatRoomId,currentChatRoomId,notifications,DataSnapshot) =>{
        ...
        let index = notifications.findIndex(notification=> 
            ...
            //notifications state 안에 해당 채팅방의 알림 정보가 없을 떄
            if(index === -1){
                notifications.push({
                    id:chatRoomId,
            ...
            //이미 해당 채팅방의 알림 정보가 있을 때
                ...
                //tottal property에 현재 전체 메시지 개수를 넣어주기
                notifications[index].total = DataSnapshot.numChildren();
            }

        //목표는 방 하나 하나의 맞는 알림 정보를 notification state에 넣어주기
    ...
    clearNotification = () =>{
        ...
        if(index !== -1){
            ...
            updatedNotifications[index].lastKnowTotal = this.state.notifications[index].total;
