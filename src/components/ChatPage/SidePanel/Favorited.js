...
export class Favorited extends Component {
    ...
    addListeners = (userId) =>{
        ...
        .on("child_added",DataSnapshot => {
            ...
            console.log("datasnapval",DataSnapshot.val())
            this.setState({
        ...
        .on("child_removed", DataSnapshot => {
            ...
            this.setState({
                favoritedChatRoom: filteredChatRooms
            })
        })
    ...
    renderFavoriteChatRooms = (favoritedChatRoom) =>
        ...
        return (
            <div>
                ...
                <ul style={{listStyleType:'none',padding:'0'}}>
                    {this.renderFavoriteChatRooms(favoritedChatRoom)}
                </ul>
            </div>
        )
    }
